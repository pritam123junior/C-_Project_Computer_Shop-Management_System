...
{
    public partial class MUserControlDash : UserControl
    {
        public MUserControlDash()
        {
            InitializeComponent();
        }

        private void MUserControlDash_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda5 = new SqlDataAdapter("select count (*) from CustomerInfo", Con);
            DataTable dt5 = new DataTable();
            sda5.Fill(dt5);
            lbiCustomer.Text = dt5.Rows[0][0].ToString();
